            ...
            <v-card color="white" class="pa-3 no_border" elevation="0">
                <v-row>
                    <v-col sm="12" cols="12" class="py-0">
                        <h2 class="mb-0 font_20">{{ $t('sale_summary_by_items_report') }}</h2>
                    </v-col>
                </v-row>
                <v-row>
                    <v-col sm="12" cols="12">
                        <gridFullScreen>
                            <template>
                                <kendo-datasource
                                    ...
                                    :server-paging="false"/>
                                <kendo-grid
                                    id="itmSaleSummary" class="grid-function"
                                    :data-source-ref="'itmSaleSummary'"
                                    :editable="false"
                                    :groupable="true"
                                    :column-menu="true"
                                    :noRecords="true"
                                    :sortable="true"
                                    :excel-file-name="$t('sale_summary_by_items_report')+'.xlsx'"
