                        ...
                        <gridFullScreen>
                            <template>
                                <kendo-datasource
                                    ...
                                    :data="creditSale" />
                                <kendo-grid
                                    id="creditSaleDS" class="grid-function"
                                    :data-source-ref="'creditSaleDS'"
                                    :editable="false"
                                    :groupable="true"
                                    :column-menu="true"
                                    :noRecords="true"
                                    :sortable="true"
                                    :excel-file-name="$t('credit_sales')+'.xlsx'"
                                    ...
                                    <kendo-grid-column
                                        ...
                                        :width="200"
                                        :hidden="true"
                                        :template="'#= Object.keys(userPin).length > 0 ? userPin.name : `` #'"
                                        :attributes="{style: 'text-align: right; ', class:'tb_name_td'}"
                                        :headerAttributes="{ style: 'background-color: #EDF1F5' }"/>
                                    <kendo-grid-column
                                        :field="'paymentMethod'"
