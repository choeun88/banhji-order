  ...
  <v-row>
    <v-col sm="12" cols="12" :class="isFund ? 'px-4 pt-0' : 'grayBg px-6'">
      <v-card color="white" class="pa-3 no_border" elevation="0">
        ...
        <div style="overflow: auto" class="by-inv-prodsrv-pager"></div>
      </v-card>
    </v-col>
...
export default {
  ...
  methods: {
    ...
    onSearch(type) {
      ...
      this.txnByEmployees = [];
      //   $(".k-pager-wrap").empty();
      //   $(".by-inv-prodsrv-page-number").empty();
      this.loadPage(this);
      this.paging = {};
      //   this.params = {
      //     search: "",
    ...
    // },
    async loadPage(that) {
      $(".by-inv-prodsrv-pager").html(`
                <label class="label by-inv-prodsrv-item-returned">0</label>
                <div style="display: flex; flex-direction: 'row'">
                    <button class="by-inv-prodsrv-next-page" title="previous" style="width: 24px; font-size: 19px;"> < </button>
                    <ul class="by-inv-prodsrv-page-number" style="display: flex;list-style: none; padding-left: 0px;">
                        <li style="padding: 6px;"  data-page="1" class="by-inv-prodsrv-page-link text-bold-link" >1</li>
                    </ul>
                    <button class="by-inv-prodsrv-next-page" title="next" style="width: 24px; font-size: 19px;"> > </button>
                </div>
            `);
      $(document).on("click", ".by-inv-prodsrv-page-link", function () {
        const page = $(this).data("page");
        $(".by-inv-prodsrv-page-link").removeClass("text-bold-link");
        $(this).addClass("text-bold-link");
        that.backToPage(that, page - 1);
        window.console.log(page - 1);
      });
      // $(document).on('click', '.by-inv-prodsrv-next-page', function () {
      $(".by-inv-prodsrv-next-page").click(function () {
        const page_number = $(this)
          .parent()
          .children(".by-inv-prodsrv-page-number")
          .find("li")
          .last()
          .data("page");
        window.console.log("by-inv-prodsrv-page_number", page_number);
        ...
        if (isPrevious == "previous") {
          ...
          $(".by-inv-prodsrv-page-link").removeClass("text-bold-link");
          $(`.by-inv-prodsrv-page-link:eq(${currectpage - 1})`).addClass(
            "text-bold-link"
          );
          ...
          $(this)
            ...
            .children(".by-inv-prodsrv-page-number")
            .append(
              `<li class="by-inv-prodsrv-page-link text-bold-link" style="padding: 6px;" data-page="${
                page_number + 1
              }">${page_number + 1}</li>`
            );
        }
    ...
    itemRetuned(that) {
      ...
      $(".by-inv-prodsrv-item-returned").text("Items returned (" + totalRow + ")");
    },
    disabledNextPage(value) {
      $(".by-inv-prodsrv-next-page").prop("disabled", value);
    },
