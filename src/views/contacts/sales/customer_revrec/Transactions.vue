      ...
      <v-card color="white" class="pa-3 no_border" min-height="564" elevation="0">
        <v-row class="">
          <v-col sm="9" cols="12" class="py-0">
            <h2 class="mb-0 font_020">{{ $t("nrd_deposit_balance_detail") }}</h2>
            <p class="mb-1">{{ $t("nrd_deposit_balance_detail_desc") }}</p>
          </v-col>
          ...
          <v-col sm="12" cols="12" class="pt-0">
            ...
            <template>
              ...
              <kendo-grid
                ...
                :resizable="true"
                :sortable="true"
                :excel-file-name="'Non refundable deposit balance detail.xlsx'"
              ...
              >
                ...
                />
                <kendo-grid-column
                  :field="'recognizedAmount'"
                  :title="$t('recognized_amount')"
                  :width="200"
                  :group-footer-template="'#= kendo.toString(sum, `n2`)#'"
                  :aggregates="['sum']"
                  :footerAttributes="{ style: 'text-align: right;' }"
                  :attributes="{ style: 'text-align: right; ' }"
                  :template="'<span>#=kendo.toString(recognizedAmount * txnRate, decimalFormat)#</span>'"
                  :headerAttributes="{
                    style: 'text-align: right;background-color: #EDF1F5',
                  }"
                />
...
export default {
  ...
  data: () => ({
    ...
    aggregateDefinition: [
      ...
      { field: "recognizedAmount", aggregate: "sum" },
    ],
    mDateSorter: "Today",
    showLoading: false,
    nrdDepositList: [],
  ...
  methods: {
    ...
    excelExport: function (e) {
      let filterExcel = {
        ...
        dateTo: this.endDate,
        title: i18n.t("nrd_deposit_balance_detail"),
        type: "",
      };
      e.workbook.sheets[0].title = i18n.t("NRD Detail");
    ...
    status(dataItem) {
      ...
      switch (dataItem.status) {
        ...
        case 2:
          if (type === "Invoice") {
            status = "Partial"; // speciall case for non refundable depsoit
          }
          break;
        case 3:
          status = "Recognized";
