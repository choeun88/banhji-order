<template>
  <v-row class="">
    <v-col sm="10" cols="12" class="pt-0">
      <h2 class="mb-0 font_020">{{ $t("customer_group") }}</h2>
      <p class="mb-0">{{ $t("customer_group_desc") }}</p>
    </v-col>
    <v-col sm="2" cols="12" class="pt-0">
      <v-dialog persistent v-model="dialogM2" max-width="700px">
                ...
                <v-col sm="6" cols="12" class="pb-0">
                  <v-row>
                    <v-col sm="11" cols="11" class="py-0">
                      <label class="label">{{ $t("default_discount_rate") }}</label>
                      <v-select
                        class="mt-1"
                    ...
                    <v-col sm="1" cols="1" class="pl-0 py-0">
                      <v-icon class="float-left mt-9" size="15"> mdi-percent </v-icon>
                    </v-col>
                  </v-row>
            ...
            <v-row>
              ...
              <v-col sm="8" cols="6" class="py-0">
                <v-btn
                  ...
                  @click.native="onSaveClose(false)"
                >
                  {{ $t("save_close") }}
                </v-btn>
                <v-btn
