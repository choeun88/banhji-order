                  ...
                  <v-card outlined dense class="px-3 py-0 rounded-0">
                    <v-row>
                      <v-col sm="6" cols="12" class="py-0">
                        ...
                        <v-textarea height="70" v-model="event.shortDesc" label=""></v-textarea>
                        <label class="label">{{ $t("en_short_description") }}</label>
                        <v-textarea height="70" v-model="event.enDesc" label=""></v-textarea>
                      </v-col>
    ...
    <v-col sm="12" cols="12">
      <template>
        <LoadingMe
          ...
          :myLoading="true"
        />
        <kendo-datasource ref="gridCategoryDS" :data="events" />
        <kendo-grid
          id="gridModiCategory"
          class="grid-function"
        ...
        >
          ...
          <!-- <kendo-grid-column
            ...
            :title="$t('name')"
            :width="150"
            :template="'<span>#= campus == 1 ? `meanchey_campus` : `toulsongke_campus`#</span>'"
            :headerAttributes="{ style: 'background-color: #EDF1F5' }"
          /> -->
          <kendo-grid-column
            :field="''"
...
<script>
  ...
  import EventModel from "@/scripts/model/Event";
  export default {
      name: "Events",
      components: {
      ...
      methods: {
          ...
          goEdit(e) {
              ...
              this.event = dataItem;
              window.console.log(this.event, 'sssss')
              this.src = "";
          ...
          onSaveClose() {
              ...
              nlfHandler.eventCreate(new EventModel(data)).then((response) => {
          ...
          loadEvents() {
              this.showLoading  = true
              nlfHandler.eventGets().then(res=>{
                this.showLoading = false
                window.console.log(res, 'res event')
